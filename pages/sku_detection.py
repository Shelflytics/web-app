...
if not st.session_state.get("authenticated", False):
    st.warning("Please log in from the main Login page.")
else:
    st.title("🧾 SKU Detection")
        ...
        if uploaded_file is None:
            ...
            if data:
                ...
                entry = {
                    ...
                    "detections": ",".join(map(str, detections)) if isinstance(detections, (list, tuple)) else str(detections),
                }
